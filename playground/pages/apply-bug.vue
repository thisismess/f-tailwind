<template>
    <div>
        ...
        <p>
            ...
            Adam Wathan demonstrated. With @apply, sibling selectors and compound class selectors break because @apply only
            copies declarations, not selector relationships. f-tailwind doesn't have this problem because it applies classes
